...
`tests/test_readme_origin_223.py` asserts the new shape: a dated measurement, a ratio
in the form "about N.N to 1", the two derivation commands, and the fresh-clone basis.
