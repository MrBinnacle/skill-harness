...
*Published to the public tree 2026-07-19; originally an internal artifact of the same date.*

**Supersedes**: the internal partial-status note of 2026-06-07.
...
Phase 4.2 azimuth (internal go/no-go check, untracked) required: ">=1 PASSED or FAILED,
