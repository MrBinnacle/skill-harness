...
- **Claims:** Three named mutants of `src/skill_harness/ablation/gate2_stopping.py`
  were each run in its own git worktree at commit `f916612` under Python 3.13.15
  against the file at `sha256:b0c0c5487de4180b685d015371d7cdc7c1fda8c50aa5818618f4f738c2d0a729`,
  ...
  first with 39 tests collected, differing source digests, a mutant that
  imports, and a byte-unchanged production tree.
- **Refuses to claim:** A mutation score — three hand-chosen mutants cannot
