...
command: skill-harness skill audit path/to/your/SKILL.md

Install the package with pip. Then run the audit on a skill file. The audit makes no API
call, needs no key, and touches no network.
