...
**Commit at generation:** `8b6aa47` — informational only. A rebase rewrites it and later
...
`ae28a10512c6` to `d3064dd5c232`; mutants re-run, all three kills held by the same detectors).
