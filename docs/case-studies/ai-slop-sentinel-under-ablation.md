...
arises from framework state, not subject behavior~~ the recorded UNMEASURED
state arises from framework state, not subject behavior and maps to the
`CANT_TELL_YET` verdict. Pre-registered the
