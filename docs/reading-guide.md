...
The README's further-reading list, moved here on 2026-09-13 with every link intact.
...
- [The receipts, rendered](https://mrbinnacle.github.io/skill-harness/) is the SERS receipts as a
  ...
  the SERS instances only; the Markdown index below is the citable record for every kind.
- [Measurement receipts index](https://github.com/MrBinnacle/skill-harness/blob/main/docs/receipts-index.md)
  ...
  the `skill audit --extraction` join, with what each one claims and where each one stops.
